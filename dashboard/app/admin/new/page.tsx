...
export default function NewLink(){
  ...
  async function submit(e:any){ e.preventDefault(); const j = await api('/api/payment-links', { method:'POST', body: JSON.stringify({ amount:Number(amount), currency, orderId }) }); setResult(j); }
