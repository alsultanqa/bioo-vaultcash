...
export default function Login(){
  ...
  async function submit(e:any){ e.preventDefault(); try{ const res = await api('/auth/login', { method:'POST', body: JSON.stringify({ email, password }) }); setToken(res.token); location.href='/admin/links'; }catch{ setErr('بيانات الدخول غير صحيحة'); } }
